...
$oauth_token = $_GET['oauth_token'];
 ...
 echo "<br>";
 echo "<br>";
 echo "<a href='http://web.njit.edu/~ko45/twitter/timeline.php'>Click here to see Timeline</a>";
 echo "<br>";
 echo "<br>";
 echo "<br>";
 echo "<a href='http://web.njit.edu/~ko45/twitter/update.php'>Click here to Update Tweet</a>";
